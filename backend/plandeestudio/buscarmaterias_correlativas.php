...
//     $sql = "SELECT * FROM materias WHERE materias.id NOT IN (SELECT correlativas.codigo_correlativa FROM correlativas WHERE correlativas.codigo_materia = $id_materias ) LIMIT  " . $start . ", " . $length;
//     "";
// }
