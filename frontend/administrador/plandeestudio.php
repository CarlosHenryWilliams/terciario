...
<body class="sb-nav-fixed" id="body">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
                        ...
                        <div class="card-header">
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <div class=" bd-highlight">
                                    <div class=" flex-shrink-1 bd-highlight"> <a href="#!" data-id="" data-toggle="modal" data-target="#modal_form_planes" class="btn btn-primary btn-sm  btnAgregar">Nuevo Plan de Estudio
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Add plan Modal -->
            <div class="modal fade" id="modal_form_planes" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form id="addUser" action="">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="input_titulo_plan" name="titulo" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="input_nombre_plan" name="nombre" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="resolucion_plan" class="col-md-3 form-label">Resolucion</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="input_resolucion_plan" name="resolucion" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="input_estado_p_plan" name="estado" required>
