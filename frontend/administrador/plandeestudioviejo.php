...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="acciones">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="modal_plan_estudio" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" id="cargar"
                                            class="btn btn-outline-success w-25">Cargar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="m-4 btn-active" id="table_habilitado">
                        ...
                        <div class="card mb-4 btn-active">
                            ...
                            <div class="card-body ">
                                <table id="tabla_habilitado_plan_estudio"
                    ...
                    <div class="m-4" id="table_deshabilitado">
                        ...
                        <div class="card mb-4 btn-active">
                            ...
                            <div class="card-body">
                                <table id="tabla_deshabilitado_plan_estudio"
                                    class="table table-bordered display responsive nowrap table-responsive "
                                    style="width:100%">
                                    <thead class="">
                                        <tr class="">
    ...
    <script src="js/cargartablahabilitados.js"></script>


    <!-- Cargar datos en la tabla deshabilitados-->
    <script src="js/cargatabladeshabilitados.js"></script>
